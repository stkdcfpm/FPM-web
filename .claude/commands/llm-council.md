...
Only save a transcript if the user asks or the question is significant enough to reference later. If saving, write to `docs/councils/YYYY-MM-DD-topic.md` in the project directory.
